...
//----------------CAN Command-----------------//
#define CAN_CALIBRATION             0xD000
#define CAN_CALI_STEP               0xD001
#define CAN_WRITE_SVR               0xD002
#define CAN_CALIBRATION_TYPE        0xD010
#define CAN_READ_PSU_MODE           0xD011
#define CAN_READ_HIGH_LIMIT         0xD012
#define CAN_READ_LOW_LIMIT          0xD013
#define CAN_CALIBRATION_POINT       0xD014
...
extern void Canbus_RxProcess(void);
